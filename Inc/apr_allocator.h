 ...
 *
 */
APR_DECLARE(apr_status_t) apr_allocator_create(apr_allocator_t **allocatorr);
 ...
 */
APR_DECLARE(void) apr_allocator_destroy(apr_allocator_t *allocatorr);
 ...
 *        memnode structure)
 */
APR_DECLARE(apr_memnode_t *) apr_allocator_alloc(apr_allocator_t *allocatorr,
                                                 apr_size_t size);
 ...
 */
APR_DECLARE(void) apr_allocator_free(apr_allocator_t *allocatorr,
 ...
 */
APR_DECLARE(void) apr_allocator_owner_set(apr_allocator_t *allocatorr,
                                          apr_pool_t *pool);
 ...
 */
APR_DECLARE(apr_pool_t *) apr_allocator_owner_get(apr_allocator_t *allocatorr);
 ...
 */
APR_DECLARE(void) apr_allocator_max_free_set(apr_allocator_t *allocatorr,
                                             apr_size_t size);
 ...
 */
APR_DECLARE(void) apr_allocator_mutex_set(apr_allocator_t *allocatorr,
